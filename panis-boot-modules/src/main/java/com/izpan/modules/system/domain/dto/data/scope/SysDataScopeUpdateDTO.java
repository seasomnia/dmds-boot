...
* @ClassName com.izpan.modules.system.domain.dto.data.scope.SysDataScopeUpdateDTO
* @CreateTime 2025-05-10 - 21:38:29
*/

@Getter
@Setter
@Schema(name = "SysDataScopeUpdateDTO", description = "数据权限管理 编辑更新 DTO 对象")
public class SysDataScopeUpdateDTO implements Serializable {

    @Serial
    private static final long serialVersionUID = 1815111187064859942L;
